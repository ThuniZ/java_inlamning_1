...
*/
//Done
//Första gången man klickar behäver man dubbel klicka för att de ska funka
let blue = false;
...
//Vet inte varför det blir ett radbyte efter bold
...
let greeting = document.getElementById("answer-nine");

function taskNine() {
  if (hour < 17) {
    greeting.style.backgroundColor = "red"
  } else {
    greeting.style.backgroundColor = "blue"
  };
